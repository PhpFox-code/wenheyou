<div class="panel panel-default">
  ...
  <div class="panel-body" style="min-height:300px;">
	...
	<form id="add" role="form" method="post" action="<?php echo \Core\URI::a2p(array('notice'=>'save'))?>">
		<input type="hidden" name="notice_id" id="notice_id" value="<?php echo $this->data->notice_id?>" />
	<div class="row">
		<div class="pull-left" style="padding: 20px; margin-right: -1px;border-right: 1px solid #ddd;">
			<div style="padding: 0px 0px 10px 10px;"><b>缩略图</b></div>
      		<div class="thumbnail img-circle" style="width: 140px; height: 140px;">
      			<div class="bg-image" style="background-image: url(<?php echo $this->data->notice_pic?>);">
      			...
      			<input id="ajax_image" type="hidden" name="ajax_image" value="<?php echo $this->data->notice_pic?>">
      		</div>
...
<!--            <input type="text" class="form-control" id="group_name" name="group_name" value="<?php echo $this->data->group_name?>" placeholder="group_name">-->
				<select name="group_name" class="form-control">
					<option value="最新活动" <?php if($this->data->group_name == '最新活动'):?>selected<?php endif;?>>最新活动</option>
					<option value="景区导览" <?php if($this->data->group_name == '景区导览'):?>selected<?php endif;?>>景区导览</option>
				</select>
						
			</div>
      		<div class="form-group"><label>内容标题</label> 
            <input type="text" class="form-control" id="notice_title" name="notice_title" value="<?php echo $this->data->notice_title?>" placeholder="notice_title">
			</div>
            <div class="form-group"><label>内容简介</label> 
            <textarea type="textarea" class="form-control" id="notice_profile" name="notice_profile" placeholder="预览的描述信息" rows="4"><?php echo $this->data->notice_profile?></textarea>
            </div>
            <div class="form-group">
            <label>内容正文</label>
            <textarea  id="notice_text" name="notice_text" placeholder="这里输入内容" autofocus><?php echo $this->data->notice_text?></textarea>
            </div>
