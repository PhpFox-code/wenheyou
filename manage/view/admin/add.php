		...
		<div class="pull-left" style="padding: 20px; margin-right: -1px;border-right: 1px solid #ddd;">
			<div style="padding: 0px 0px 10px 10px;"><b>缩略图</b></div>
      		<div class="thumbnail img-circle" style="width: 140px; height: 140px;">
      			...
      			<input id="ajax_image" type="hidden" name="ajax_image" value="">
      		</div>
		...
		<div style="margin-left: 180px;width: auto; border-left: 1px solid #ddd; padding: 20px;">
			<div>
				<div class="col-md-6" style="padding-left: 0px;">
		            ...
		            <input type="text" class="form-control" id="admin_name" name="admin_name" placeholder="姓名">
		            </div>
				</div>
			...
			<div>
				<div class="col-md-6" style="padding-left: 0px;">
            		...
            		<input type="text" class="form-control" id="admin_account" name="admin_account"  placeholder="邮箱帐号">
		            </div>
				</div>
				<div class="col-md-6" style="padding-right: 0px;">
					<div class="form-group"><label>密码</label> 
		            <input type="password" class="form-control" id="admin_password" name="admin_password"  placeholder="密码">
		            </div>
				</div>
			</div>
			<div>
				<div class="col-md-6" style="padding-left: 0px;">
		            ...
		            <input type="number" class="form-control" id="admin_mobile" name="admin_mobile" placeholder="手机号码">
		            </div>
				</div>
				<div class="col-md-6" style="padding-right: 0px;">
					<div class="form-group"><label>更新时间</label> 
		            <input type="text" class="form-control" disabled id="create_time" name="create_time">
		            </div>
				</div>
			</div>
