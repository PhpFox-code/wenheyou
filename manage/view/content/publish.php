              ...
              <div class="tab-pane fade active in" id="news">
                ...
                <form role="form" method="post" action="/content/save" style="padding:10px;">
                  <div class="form-group">
                    <label>内容标题</label>
                    <input type="text" class="form-control" name="content_title"  placeholder="名称">
                  </div>
                  
                  <div class="form-group">
                    <label>内容摘要</label>
                    <textarea type="textarea" class="form-control" name="content_description"  placeholder="预览的描述信息" rows="4"></textarea>
                  </div>
            
                  <div class="form-group">
                    <label>内容正文, 第一张图片将被用作微信news信息的封面</label>
                    <textarea  id="edit" name="content_text" placeholder="这里输入内容" autofocus></textarea>
                  </div>
