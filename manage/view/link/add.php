  ...
  <div class="panel-body" style="min-height:300px;">
	...
	<dl class="dl-horizontal" style="padding:20px 20px 0px 0px;">
      ...
      <dd>
            ...
            <input type="text" class="form-control" name="link_name" value="" placeholder="链接名称">
			</div>
            ...
            <input type="text" class="form-control" name="link_order" value="1">
            </div>
            <div class="form-group"><label>链接地址</label> 
            <input type="text" class="form-control" name="link_url" value="" placeholder="http://www.sony.com">
            </div>
