		...
		<div class="pull-left" style="padding: 20px; margin-right: -1px;border-right: 1px solid #ddd;">
			<div style="padding: 0px 0px 10px 10px;"><b>缩略图</b></div>
      		<div class="thumbnail img-circle" style="width: 140px; height: 140px;">
      			<div class="bg-image" style="background-image: url(<?php echo $this->data->slide_pic?>);">
      			...
      			<input id="ajax_image" type="hidden" name="ajax_image" value="<?php echo $this->data->slide_pic?>">
      			<input id="slide_id" type="hidden" name="slide_id" value="<?php echo $this->data->slide_id?>">
      		</div>
		...
		<div style="margin-left: 180px;width: auto; border-left: 1px solid #ddd; padding: 20px;">
            <div class="form-group"><label>打开方式</label> 
				<select id="slide_target" name="slide_target" class="form-control">
                    <option value="_blank" <?php if($this->data->slide_target == '_blank'):?>selected<?php endif;?>>_blank</option>
                    <option value="_self" <?php if($this->data->slide_target == '_self'):?>selected<?php endif;?>>_self</option>
                    <option value="_parent" <?php if($this->data->slide_target == '_parent'):?>selected<?php endif;?>>_parent</option>
                </select>
            </div>
            <div class="form-group"><label>排序(数值越大越靠前)</label> 
            <input type="text" class="form-control" id="slide_order" name="slide_order" value="<?php echo $this->data->slide_order?>">
            </div>
            <div class="form-group"><label>标题</label> 
            <input type="text" class="form-control" id="slide_title" name="slide_title" value="<?php echo $this->data->slide_title?>">
            </div>
            <div class="form-group"><label>链接地址</label> 
            <input type="text" class="form-control" id="slide_link" name="slide_link" value="<?php echo $this->data->slide_link?>" placeholder="http://www.domain.com">
            </div>
